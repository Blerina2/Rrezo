function ndryshoNgjyren() {
    if (document.documentElement.style.backgroundImage === 'url("../images/dashboardImagePurple.png")') {
        ...
        document.documentElement.style.setProperty('--background-image-rrezo', 'url(../images/dashboardImagePurple.png)');
        document.documentElement.style.backgroundImage = 'url(../images/dashboardImagePurple.png)';
